...
int8_t Sensor_Ublox_GNSS::setup() {
    log("Startup...");
    _pipe->begin();
...
uint16_t Sensor_Ublox_GNSS::GPSweek() {
...
uint32_t Sensor_Ublox_GNSS::actualTimeOfWeekms() {
...
int8_t Sensor_Ublox_GNSS::performOnlineAssist() {
